...
import type { Tour } from "@/types/tour" // Importa la interfaz Tour existente
...
export default function PackagesSection() {
  ...
  const [itemsPerView, setItemsPerView] = useState(3) // Estado para el número de ítems por vista
  ...
  const getTourDisplayData = (tour: Tour) => {
    return {
      ...
      highlights: tour.highlights || [], // highlights es string[]
    }
  }

  if (loading) {
    return (
      <section id="packages-section" className="py-12 md:py-16 lg:py-24 bg-white">
              ...
              {tours.map((tour, index) => {
                ...
                return (
                  <motion.div
                    ...
                    onMouseEnter={() => itemsPerView !== 1 && setHoveredCard(tour._id)} // Solo hover en desktop
                    onMouseLeave={() => itemsPerView !== 1 && setHoveredCard(null)} // Solo hover en desktop
                  >
                    <motion.div
                      onClick={() => {
                    ...
                    >
                      ...
                      <motion.div
                        ...
                        animate={{
                          height:
                            itemsPerView === 1 // Si es móvil, altura fija generosa
                              ? "240px" // Altura fija para móvil que siempre muestra botones
                              : hoveredCard === tour._id // Si es desktop, usa hover
                                ? "420px"
                                : "140px",
                        }}
                        ...
                        <div className="p-4 md:p-6 lg:p-8 h-full">
                          ...
                          <AnimatePresence>
                            {(hoveredCard === tour._id || itemsPerView === 1) && (
                              ...
                              >
                                {/* Cuadrícula de detalles del tour */}
